...
if (segmento_b - segmento_c) < segmento_a < segmento_b + segmento_c and (segmento_a - segmento_c) < segmento_b < \
        segmento_a + segmento_c and (segmento_a - segmento_b) < segmento_c < segmento_a + segmento_b:
